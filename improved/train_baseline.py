...
def build_pipeline():
    ...
    # metadata: domain + numeric reliability features
...
def main():
    ...
    needed = {"text", "label", "source_domain", "is_reliable_domain", "reliability_score"}
    missing = needed - set(train_df.columns)
    if missing:
        raise SystemExit(f"train file missing columns: {sorted(missing)}")
